...
export class IoC {
    ...
    resolve<T>(request : DependencyRequest) : T {
        return <T> this.resolveAny(request)
    }
    ...
    resolveAny(request : DependencyRequest) : any {
        ...
        if (<ClassRef> request) {
            ...
            return this.create(<ClassRef> request)
        }
    ...
    getIdentity(request : DependencyRequest) : string {
        if (<ClassRef> request) {
            return (<ClassRef> request).name
        }
        if (<IDependencyRequest> request) {
            return (<IDependencyRequest> request).identity
        }
        if (<string> request) {
    ...
    getField(request : DependencyRequest) : string {
        ...
        if (<IDependencyRequest> request) {
            return (<IDependencyRequest> request).to
        }
        if (<string> request) {
            return <string> request
        } 
